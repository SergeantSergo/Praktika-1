    ...
    public partial class RBProductDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.relationПоставщикиТовары = new global::System.Data.DataRelation("ПоставщикиТовары", new global::System.Data.DataColumn[] {
                        this.tableЗаказчики.Код_поставщикаColumn}, new global::System.Data.DataColumn[] {
        ...
        public partial class ТоварыDataTable : global::System.Data.TypedTableBase<ТоварыRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ТоварыRow AddТоварыRow(string Наименование, string _Цена___, ЗаказчикиRow parentЗаказчикиRowByПоставщикиТовары) {
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        _Цена___,
                        null};
                if ((parentЗаказчикиRowByПоставщикиТовары != null)) {
                    columnValuesArray[3] = parentЗаказчикиRowByПоставщикиТовары[0];
                }
        ...
        public partial class ТоварыRow : global::System.Data.DataRow {
            ...
            public ЗаказчикиRow ЗаказчикиRow {
                get {
                    return ((ЗаказчикиRow)(this.GetParentRow(this.Table.ParentRelations["ПоставщикиТовары"])));
                }
                set {
...
namespace WinBD.RBProductDataSetTableAdapters {
    ...
    public partial class ЗаказчикиTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Заказчики` WHERE ((`Код поставщика` = ?) AND ((? = 1 AND `Поставщик`" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Заказчики` (`Поставщик`, `Адрес поставщика`, `Телефон`) VALUES (?, ?" +
                ", ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Заказчики` SET `Поставщик` = ?, `Адрес поставщика` = ?, `Телефон` = ? WHERE ((`Код поставщика` = ?) AND ((? = 1 AND `Поставщик` IS NULL) OR (`Поставщик` = ?)) AND ((? = 1 AND `Адрес поставщика` IS NULL) OR (`Адрес поставщика` = ?)) AND ((? = 1 AND `Телефон` IS NULL) OR (`Телефон` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [Код поставщика], Поставщик, [Адрес поставщика], Телефон FROM Заказчики";
        ...
        public virtual int Fill(RBProductDataSet.ЗаказчикиDataTable dataTable) {
        ...
        public virtual RBProductDataSet.ЗаказчикиDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            RBProductDataSet.ЗаказчикиDataTable dataTable = new RBProductDataSet.ЗаказчикиDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(RBProductDataSet.ЗаказчикиDataTable dataTable) {
