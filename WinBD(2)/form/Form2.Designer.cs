namespace Praktika
{
    partial class Form2
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dataSet111 = new Praktika.dataSet11();
            ...
            this.dataGridView1.DataSource = this.dataSet111BindingSource;
            ...
            // oleDbSelectCommand1
            // 
            this.oleDbSelectCommand1.CommandText = "SELECT        Код, Имя, Фамилия\r\nFROM            Заказчики";
            this.oleDbSelectCommand1.Connection = this.oleDbConnection1;
            // 
            // oleDbInsertCommand1
            // 
            this.oleDbInsertCommand1.CommandText = "INSERT INTO `Заказчики` (`Имя`, `Фамилия`) VALUES (?, ?)";
            ...
            // oleDbUpdateCommand1
            // 
            this.oleDbUpdateCommand1.CommandText = "UPDATE `Заказчики` SET `Имя` = ?, `Фамилия` = ? WHERE ((`Код` = ?) AND ((? = 1 AN" +
